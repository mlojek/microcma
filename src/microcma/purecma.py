...
try:
    from .interfaces import BaseDataLogger as _BaseDataLogger
    from .interfaces import OOOptimizer
...
class CMAESDataLogger(_BaseDataLogger):  # could also inherit from object
    ...
    def plot(self, fig_number=322):
        ...
        from matplotlib.pylab import (draw, figure, gca, gcf, grid, ion, plot,
                                      rcParamsDefault, semilogy, show)
        from matplotlib.pylab import subplot as _subplot
        from matplotlib.pylab import text, tight_layout, xlabel, xlim, ylim
